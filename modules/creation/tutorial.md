...
**Module's technical name must be:**
* Only word characters (A-z, 0-9) are supported.
* Does not contain contains underscores "_" or any other unsupported symbol
...
{{% notice note %}}
You can read more about this component in [Legacy Configuration object]({{< ref "/1.7/development/components/configuration/backward-compatibility" >}}) and [Configuration storage]({{< ref "/1.7/development/components/configuration" >}}).
{{% /notice %}}
...
For more informations, please read [the reference of the ModuleCommand]({{< ref "/1.7/development/components/console/prestashop-module" >}})
